...
public static class AnimancerUnityTimelineExtend
{
    ...
    {
        if (state == null || !state.IsValid || state.Root?._Graph == null)
            return;
    ...
    public static AnimancerState PlayTimeline(this AnimancerComponent component, PlayableAssetTransitionAsset asset, float fadeDuration, FadeMode mode = default, bool bindSignal = false) {
        if (asset == null)
            return null;
        AnimancerState temp;
    ...
    public static AnimancerState PlayTimeline(this AnimancerComponent component, PlayableAssetTransitionAsset asset, bool bindSignal = false) {
        if (asset == null)
            return null;
        AnimancerState temp;
        if (component.States.TryGet(asset, out temp)) {
