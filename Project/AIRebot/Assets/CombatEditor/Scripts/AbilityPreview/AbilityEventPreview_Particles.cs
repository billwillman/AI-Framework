...
namespace CombatEditor
{
	...
	public class AbilityEventPreview_Particles : AbilityEventPreview_CreateObjWithHandle
	{
		...
		public void SimulateParticles(float ScaledPercentage)
		{
			...
			if (Obj.IsActive)
			{
				ParticleSystem particleSys = InstantiatedObj.GetComponent<ParticleSystem>();
				if (particleSys == null)
				{
					Debug.LogWarning("No ParticleSystem Component Found in Particle Preview Object Or Their Has Your Own Module In Particle Preview Object.");
					return;
				}
